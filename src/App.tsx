...
function App() {
  const tecnologias:Array<Item> = [new Item({tema:"Git"}),new Item({tema:"Github",icon:<FaGithub/> }),new Item({tema:"HTML"}),new Item({tema:"CSS"}),new Item({tema:"JavaScript"}),new Item({tema:"React"}),new Item({tema:"TypeScript"}),new Item({tema:"Node.js"}),new Item({tema:"HandleBars"}),new Item({tema:"C"}),new Item({tema:"JAVA"}),new Item({tema:"Dart"}),new Item({tema:"Flutter"})]
