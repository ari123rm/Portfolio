...
function App() {
  ...
  for(let i:number = 0;i<10;i++){
    projetos.push(new Item({tema:"Projeto X",imagem: projectXImg , texto:"Lorem, ipsum dolor sit amet consectetur adipisicing elit. Iusto ea sapiente totam corrupti illo obcaecati recusandae! Minus explicabo assumenda iste."}));
  }
